...
function submitForm(e){
  ...
  //hashiando o email recebido, incrementando no redirect e gravando cookieEmpU
  var emailHash = btoa($("input[name='emailAddress']").val());

  incrementRedirect('e', emailHash);
  ...
  function sendTermsAccept(){
    ...
    $.ajax({
      ...
      if(cookieEmpAllowCookies !== null) console.log('tem COOKIE_EMP_ALLOW_COOKIES');
      else setCookie('COOKIE_EMP_ALLOW_COOKIES', 'allow', 22000);
